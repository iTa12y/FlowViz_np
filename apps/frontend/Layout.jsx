...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/[0.08] bg-slate-950/80 backdrop-blur-xl backdrop-saturate-150 supports-[backdrop-filter]:bg-slate-950/60">
        <div className="w-full px-6">
          <div className="flex items-center justify-between h-20">
            {/* Enhanced Logo Section */}
            <Link to={createPageUrl('')} className="flex items-center gap-4 group">
              <div className="relative">
                <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-cyan-400 via-cyan-500 to-blue-600 flex items-center justify-center shadow-lg shadow-cyan-500/25 group-hover:shadow-cyan-500/40 transition-all duration-300">
                  <Shield className="w-6 h-6 text-white drop-shadow-sm" />
                </div>
                <div className="absolute -inset-0.5 rounded-2xl bg-gradient-to-br from-cyan-400 to-blue-600 opacity-20 blur-sm group-hover:opacity-30 transition-opacity duration-300" />
              </div>
            ...
            <div className="hidden lg:flex items-center max-w-md mx-8 flex-1">
              <div className="relative w-full">
                ...
                <input
                  type="text"
                  placeholder="Search flows, incidents, or techniques..."
                  className="w-full pl-10 pr-4 py-2.5 bg-white/5 border border-white/10 rounded-xl text-slate-200 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500/50 transition-all duration-200"
                />
              </div>
            </div>
            ...
            <div className="hidden md:flex items-center gap-2">
              {navItems.map((item) => {
                ...
                return (
                  <Link
                    ...
                    className={`relative flex items-center gap-3 px-5 py-3 rounded-xl text-sm font-medium transition-all duration-200 ${
                      isActive
              ...
              <div className="flex items-center gap-3 ml-4 pl-4 border-l border-white/10">
                {/* Notifications */}
                <button className="relative flex items-center justify-center w-10 h-10 rounded-xl bg-white/5 hover:bg-white/10 transition-colors">
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-3 px-4 py-2.5 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 transition-all duration-200"
                  >
